 ...
 */
public class Hibrid extends  Vehicle {
    ...
    public Hibrid(String tin, String wheel, String seats, String engine, String oolingSystem, String lightingSystem, String battery) {
